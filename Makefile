...
#    Updated: 2026/08/04 16:12:03 by xalves           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# SOURCE FILES
SRC_FILES = main.c inputs.c init.c draw_funcs.c raycast.c textures.c math_funcs.c movement.c collisions.c cast_ray_helper.c
